...
require_once($CFG->dirroot.'/grade/export/groupfilter_txt/grade_export_groupfilter_txt.php');
...
require_capability('gradeexport/groupfilter_txt:publish', $context);
...
$export = new grade_export_groupfilter_txt($course, $groupid, $formdata);
$export->print_grades();
