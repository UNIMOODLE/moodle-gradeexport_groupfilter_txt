...
class grade_export_form extends \grade_export_form {
    ...
    function definition() {
        global $CFG;
        parent::definition();
        $element = $this->_form->createElement('header', 'userfieldsheader', get_string('userfieldsheader', 'gradeexport_groupfilter_xls'));
        ...
        $userfieldslabel = $this->_form->createElement('static', 'label_userfields', get_string('userfields_form', 'gradeexport_groupfilter_xls'));
