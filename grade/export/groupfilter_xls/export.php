...
$PAGE->set_url('/grade/export/groupfilter_xls/export.php', array('id'=>$id));
...
$mform = new \gradeexport_groupfilter_xls\grade_export_form(null, array('publishing' => true, 'simpleui' => true, 'multipledisplaytypes' => true));
// Form processing and displaying is done here.
if ($mform->is_cancelled()) {
    // If there is a cancel element on the form, and it was pressed,
    // then the `is_cancelled()` function will return true.
    // You can handle the cancel operation here.
    redirect( $CFG->wwwroot . "/grade/export/groupfilter_xls/index.php?id=" . $id , "Form Canceled", null, \core\output\notification::NOTIFY_INFO);
