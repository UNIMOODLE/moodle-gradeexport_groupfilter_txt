...
Feature: I need to export grades as text and ordered by groups
  ...
  @javascript
  Scenario: Export grades as text file with a user roled in diferent groups
    Given the following "users" exist:
      | username | firstname | lastname | email |
  ...
  @javascript
  Scenario: Export grades as text using user custom fields with user being roled in a group
    Given the following "users" exist:
      | username | firstname | lastname | email |
      | student1 | Student_name | Student_lastname | student1@example.com |
    And the following "course enrolments" exist:
  ...
  @javascript
  Scenario: Export grades as text adding a user profield field with user being roled in a group
    Given the following "users" exist:
