...
Feature: I need to export grades as text and ordered by groups
  ...
  Scenario: Export grades as text file with two users from diferent groups
    ...
    When I navigate to "Groupfilter Plain text file" export page in the course gradebook
  ...
  @javascript @export_user_profield_filtered_group
  ...
  Scenario: Export grades as text using user custom fields with user being rolled in a group
    ...
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I navigate to "Groupfilter Plain text file" export page in the course gradebook
    And I expand all fieldsets
    And  I set the following fields to these values:
      | First name   | 1                        |
      | Last name    | 1                        |
